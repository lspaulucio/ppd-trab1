...
Ao final desse trabalho pode-se concluir que existem diferentes estruturas de mercado, cada uma com suas próprias características e dinâmicas que acabam sendo diretamente responsáveis pela forma como são estabelecidos os preços e as ofertas dos bens e serviços para o mercado.

Foi possível perceber também que o modelo "ideal" para todos seria o modelo de concorrência perfeita, onde nenhuma empresa ou consumidor seria capaz de exercer influência sobre os preços ou quantidades dos produtos, porém viu-se que esse modelo acaba por não existir no mundo real.

Portanto, o estudo da forma como o mercado está estruturado é de extrema importância para se conseguir compreender a dinâmica dos preços e da oferta de um determinado produto. Além disso, o conhecimento dessas esturutras permite que um futuro empresário possa conhecer as dificuldades(barreiras) que irá encontrar para ingressar no mercado, podendo assim analisar se irá valer a pena ou não abrir um negócio em um determinado local.
